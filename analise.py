...
class AnalisadorBackhaul:
    ...
    def carregar_dados_csv(self, caminho_arquivo: str, municipio_filtro: str = None) -> None:
    ...
    def gerar_relatorio(self) -> str:
        ...
        relatorio = []
        relatorio.append("=" * 80)
        relatorio.append("📊 ANÁLISE DE PRESTADORAS DE BACKHAUL - SÃO JOSÉ DOS CAMPOS")
        relatorio.append("=" * 80)
...
def main():
    ...
    analisador = AnalisadorBackhaul()
    
    print("🔄 Carregando dados de São José dos Campos do arquivo original...")
    analisador.carregar_dados_csv("backhaul_municipios_2023-2024.csv", "São José dos Campos")
    ...
    caminho_relatorio = Path(__file__).parent / "relatorio_sjc_backhaul.txt"
